...
console.log('Gustavo Santos'.split(' '));

const [firstName, lastName] = 'Gustavo Santos'.split(' ');
...
capitalizeName('gustavo de paula santos');

// Padding
const message = 'Go to gate 23!';
console.log(message.padStart(25, '+').padEnd(30, '+'));
console.log('Gustavo'.padStart(25, '+').padEnd(30, '+'));
...
console.log(maskCreditCard(4984123456781234));
console.log(maskCreditCard('498412345678123473733'));
...
// Comparing emails
const email = 'hello@gustavo.io';
const loginEmail = ' Hello@gustavo.io \n';
...
console.log(new String('gustavo'));
console.log(typeof new String('gustavo'));
...
// [key, value]
// for (const [{ team1, draw, team2 }] of entries) {
//   console.log(`Odd of victory ${team1}: ${}`);
// }
...
// Arrays
const users = [{ name: 'GUstavo', email: 'gdepaula@gmail.com' }];
...
// Objects
const newRestaurant = { founderIn: 1988, ...restaurant, founder: 'Gustavo' };
