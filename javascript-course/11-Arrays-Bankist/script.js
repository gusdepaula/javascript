...
const checkDogs = function (dogsJulia, dogsKate) {
  ...
  allDogs.forEach(function (age, key) {
    if (age >= 3) {
...
const calcAverageHumanAge = function (ages) {
  const humanAges = ages.map(function (dogAge) {
    ...
    // if (dogAge <= 2) {
    //   console.log(
    //     `Dog age is ${dogAge} and human age is ${2 * dogAge} years old`
    //   );
    // } else if (dogAge > 2) {
    //   console.log(
    //     `Dog age is ${dogAge} and human age is ${16 + dogAge * 4} years old`
    //   );
    // }
  });

  const adults = humanAges.filter(function (dogAge) {
    if (dogAge >= 18) {
      return dogAge;
    }
  });
  //   const adults = ages.filter(function (dogAge) {
  //     const adultDog = 16 + dogAge * 4;
  //     if (dogAge > 2) {
  //       console.log(`Dog ${dogAge} is not a puppy`);
  //     }
  //   });

  const average = adults.reduce(function (acc, dogAge) {
    return acc + dogAge / adults.length;
  }, 0);
...
console.log(`--Data 1: [5, 2, 4, 1, 15, 8, 3]--`);
calcAverageHumanAge([5, 2, 4, 1, 15, 8, 3]);
console.log(`--Data 2: [16, 6, 10, 5, 6, 1, 4]--`);
...
// Strings
const owners = [];
for (const account of accounts) owners.push(account.owner);
